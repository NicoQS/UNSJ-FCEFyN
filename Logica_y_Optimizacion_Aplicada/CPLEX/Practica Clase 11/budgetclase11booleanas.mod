...
dvar boolean x1; // Proyecto P1
dvar boolean x2; // Proyecto P2  
dvar boolean x3; // Proyecto P3
dvar boolean x4; // Proyecto P4
dvar boolean x5; // Proyecto P5
...
execute salida {
  if (cplex.getCplexStatus()==1){
    ...
    writeln("P1\t\t" + (x1 == 1 ? "Si" : "No"));
    writeln("P2\t\t" + (x2 == 1 ? "Si" : "No"));
    writeln("P3\t\t" + (x3 == 1 ? "Si" : "No"));
    writeln("P4\t\t" + (x4 == 1 ? "Si" : "No"));
    writeln("P5\t\t" + (x5 == 1 ? "Si" : "No"));
  }
}